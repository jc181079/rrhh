...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'rrhh', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\loging\\loginBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\personal\\personalBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\definiciones\\definicionesBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'loging\\loginBundle\\Entity');
        $c->addDriver($b, 'personal\\personalBundle\\Entity');
        $c->addDriver($b, 'definiciones\\definicionesBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('logingloginBundle' => 'loging\\loginBundle\\Entity', 'personalBundle' => 'personal\\personalBundle\\Entity', 'definicionesBundle' => 'definiciones\\definicionesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f5e3439d27cdfc12de9b9aa67be72f101f72aff0b1b6a94d212f728d8a88f195');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\loging\\loginBundle/Resources/views'), 'loginglogin');
        $instance->addPath(($this->targetDirs[3].'\\src\\menu\\menuPrincipalBundle/Resources/views'), 'menuPrincipal');
        $instance->addPath(($this->targetDirs[3].'\\src\\personal\\personalBundle/Resources/views'), 'personal');
        $instance->addPath(($this->targetDirs[3].'\\src\\definiciones\\definicionesBundle/Resources/views'), 'definiciones');
        $instance->addPath(($this->targetDirs[3].'\\src\\recibo\\RecPagoBundle/Resources/views'), 'RecPago');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4daa4676800a2b6dab713049c2f854ffe38e252b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b8a70f24c489.94248431')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'logingloginBundle' => 'loging\\loginBundle\\logingloginBundle',
                'menuPrincipalBundle' => 'menu\\menuPrincipalBundle\\menuPrincipalBundle',
                'personalBundle' => 'personal\\personalBundle\\personalBundle',
                'definicionesBundle' => 'definiciones\\definicionesBundle\\definicionesBundle',
                'RecPagoBundle' => 'recibo\\RecPagoBundle\\RecPagoBundle',
            ...
            'secret' => '4daa4676800a2b6dab713049c2f854ffe38e252b',
            'locale' => 'en',
            ...
            'kernel.secret' => '4daa4676800a2b6dab713049c2f854ffe38e252b',
